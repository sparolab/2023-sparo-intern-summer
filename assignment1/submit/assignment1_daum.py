...
Original file is located at
    https://colab.research.google.com/drive/1yrrnxEONnyGnyGcvppS-Gt3W8jabwsr8
"""
...
## =================================================================
C22L = np.dot(C02L, np.linalg.inv(C02C2))
## =================================================================
...
## 3. Normalization
ptcloud_C2_normalized = ptcloud_C2[:3] / ptcloud_C2[2]

## 4. 이미지 바깥에 있는 Point (Outlier) 제거
perspective_projection = np.dot(P[:,:3], ptcloud_C2_normalized)
u = perspective_projection[0]
v = perspective_projection[1]
mask = ((u >= 0) & (u < w) & (v >= 0) & (v < h))
u, v, z = u[mask], v[mask], ptcloud_C2[2][mask]
