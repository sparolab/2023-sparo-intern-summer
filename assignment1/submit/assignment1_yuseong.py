...
## =================================================================
## C0 -> LiDAR Extrinsic Parameter 카메라 외부 파라미터
## =================================================================
...
C22L = np.matmul(C02C2, C02L).T
# C22L은 C2 에서 L 로의 변환 행렬 
## =================================================================
...
# 이 이후가 1번 pintcloud 를 카메라 2 좌표계로 변환하는것 

## ptcloud 배열에 4번째 열에 1을 추가하여 4xN 형태의 배열생성후 전치 C. 이 에러가 나서 numpy 라이브러리를 사용
...
## 2. 카메라 좌표계에 맞게 뒤를 보는 부분 제거 // 렌즈 축 Z , Z>0

ptcloud_C2 = ptcloud_C2[:, ptcloud_C2[2] > 0]


## 3. Normalization / normalized image plane 으로 만들기 위해 Xc. Yc 를 Zc 로 나누어준다.
