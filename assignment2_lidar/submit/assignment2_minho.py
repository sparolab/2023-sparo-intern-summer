# -*- coding: utf-8 -*-
"""assignment2_minho.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OWVsFd7O4h2oNAIt6M22_4L9mm2PU7mo
"""
...
def pointcloud_to_range_img(current_vertex, fov_up, fov_down, proj_H, proj_W, max_range):
  ...
  # yaw : 센서 좌표계의 xy평면에서 수평 방향으로의 시계방향으로 증가하는 회전 각도
  # pitch : 센서 좌표계의 xz평면에서 수직 방향으로의 회전 각도
  yaw = np.arctan2(scan_y, scan_x)
  pitch = np.arcsin(scan_z / depth)
  print('yaw:', np.degrees(yaw))
  print('pitch:', np.degrees(pitch))

  u = proj_W * (yaw + np.pi) / (2 * np.pi)
  v = proj_H * (0.5 - pitch / fov)
  print('u:', u)
  print('v:', v)
